		...
		<div class="search_frm">
			...
			<div class="select_box dataTables_length">
				...
				<select name="search_page" id="search_page" class="info_select">
					...
					<option value="25" <?php echo set_select('search_page', 25, (get_field('search_page')==25)); ?>>25개씩 보기</option>
...
<div class="tablewrap">
	...
	<?php foreach($notices['data'] as $item) : ?>
		<tr>
			...
			<td>
				<?php switch($item['new_state']) : case '1' : ?>
					<span class="prog_state ing">접수중</span>
				<?php break; case '2' : ?>
					<span class="prog_state deadline">마감</span>
				<?php break; case '3' : ?>
					<span class="prog_state">접수전</span>
				<?php endswitch; ?>
	...
	<?php endforeach; ?>
	<?php if(empty($notices['data']) && empty($artices['data'])) : ?>
		<tr>

<div class="tablewrap">
	...
	<p class="btn_wrap text-center">
		<?php if($data['state'] == 0 || $data['ismodify'] == 'Y') :?>
			<?php if($data['state'] == 0) :?>
				<button type="submit" class="btn btn-primary"><span class="icon-ok-circle">최종접수</span></button>
			<?php endif;?>
			<a href="<?php echo $this->link->get(array('action'=>'modify', 'id'=>$data['id'], 'pid'=>NULL)); ?>" class="btn btn-default"><span class="icon-edit">수정</span></a>
		<?php endif;?>

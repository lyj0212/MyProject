		...
		<section id="content">
			<div class="emailCertify_wrap">
				...
				<div class="emailCertify_joincomplete">
					<p class="heading">
						<strong><span></span><em>이메일 인증</em>이 되지 않았습니다.</strong>
						<strong><span>발송드린 이메일정보와 현재 회원님의 정보가 일치하지 않습니다.</strong>
					...
					<div class="join_email">
						...
						<p class="txtp"></p>
						<p class="heading">
						    <strong>로그인 후 <em>이메일 재 발송</em>을 받아주시기 바랍니다.</strong>
                        </p>
						<div class="btn_wrap">
							<a href="/login"><button type="button" class="btn btn-primary">로그인 이동</button></a>
						</div>
					</div>
				</div>
			</div>

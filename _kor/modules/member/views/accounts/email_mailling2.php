    ...
    <div style="position:relative;width:100%;text-align:center">
        ...
        <div style="display:block;position:relative;letter-spacing:-0.04em">
            ...
            <p style="padding:25px 0 20px;margin:0">
                <span style="display:block"><em style="font-style:normal;color:#000;text-decoration:underline"><?php echo $data['userid']; ?></em> / <?php echo $data['name']; ?>으로 이메일 인증이 필요합니다. <br/>아래 "링크" 주소를 클릭하신 후에 센터 홈페이지로 이동하시면 모든 서비스 사용이 가능합니다. 감사합니다.</span>
            </p>
            <p style="padding:0 0 35px;margin:0">
                <span style="display:block"><span style="font-weight:bold">링크 :</span> <a style="display:inline-block;line-height:26px;color:#000" href="<?php echo site_url($this->link->get(array('prefix'=>'login', 'controller'=>'accounts', 'action'=>'accredit_check', 'email'=>encode_url($data['userid']), 'accredit'=>$data['accredit']), TRUE)); ?>" target="_blank" title="새창에서 열림">메일인증하기</a></span>
            </p>

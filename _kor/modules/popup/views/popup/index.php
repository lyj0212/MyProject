...
<colgroup>
	...
	<col width="*" />
	<col width="170" class="hidden-phone" />
...
<tr>
	...
	<td class="hidden-phone centered"><?php echo date('Y-m-d', strtotime($item['start_date'])); ?> ~ <?php echo date('Y-m-d', strtotime($item['end_date'])); ?></td>
...
<div class="well well-small clearfix">
	<div class="pull-right">
		<a class="btn btn-success" href="<?php echo $this->link->get(array('action'=>'write')); ?>">팝업 추가</a>
	</div>
</div>
